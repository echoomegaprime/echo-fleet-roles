...
description: Direct ECHO fleet strategy, priority, dispatch, incident command, and decision persistence. Use for cauto commander sessions, cross-lane coordination, portfolio triage, or any task that must turn live fleet state into verified outcomes.
---
