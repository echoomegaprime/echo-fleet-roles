---
name: echo-builder-power
description: Implement and ship production-grade ECHO changes with tests, isolated ownership, deployment gates, and durable proof. Use for cauto builder sessions, queue claims, feature work, fixes, or refactors.
---
...
Load `$superpowers:test-driven-development`, `$superpowers:verification-before-completion`, `$echo-risk-action-review`, and `$skills-gateway`; load the task-specific implementation skill whenever one matches.
