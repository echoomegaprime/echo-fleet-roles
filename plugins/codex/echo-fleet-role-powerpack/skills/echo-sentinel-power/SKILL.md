...
description: Defend ECHO systems through continuous security assessment, threat modeling, incident containment, and verified remediation. Use for cauto sentinel sessions, security posture reviews, findings, or defensive operations.
---
