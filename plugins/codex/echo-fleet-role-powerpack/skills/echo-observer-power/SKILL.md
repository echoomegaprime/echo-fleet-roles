...
description: Monitor ECHO services, diagnose anomalies, repair bounded failures, and harden recurrence controls. Use for cauto observer sessions, uptime watch, drift detection, incident response, or health verification.
---
