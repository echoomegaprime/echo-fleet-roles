...
description: Operate and improve the integrated ECHO cognition, persona, memory, voice, vision, and action runtime. Use for cauto echo-prime sessions or cross-system intelligence behavior.
---
...
Load `$echo-prime-core`, `$echo-omnipresence-operator`, `$echo-astral-orchestration`, `$echo-graph-mode`, and `$echo-proofline-verification`.
