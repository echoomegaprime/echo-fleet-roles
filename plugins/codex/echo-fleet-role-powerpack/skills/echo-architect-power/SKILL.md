...
description: Design ECHO systems, ADRs, threat models, interfaces, and acceptance-gated build phases. Use for cauto architect sessions, cross-module design, migration planning, or builder-ready specifications.
---
