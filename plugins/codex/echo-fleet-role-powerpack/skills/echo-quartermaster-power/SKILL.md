...
description: Equip ECHO roles with validated tools, MCP servers, skills, plugins, and capability routes. Use for cauto quartermaster sessions, tool inventory, missing capabilities, plugin installation, or fleet enablement.
---
