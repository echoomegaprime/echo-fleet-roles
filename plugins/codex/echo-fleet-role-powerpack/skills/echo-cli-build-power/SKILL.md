...
description: Drive durable autonomous builds through ECHO CLI lanes with ownership, resumability, tests, and truthful completion. Use for cauto cli-build sessions or long-running command-line build missions.
---
