...
description: Improve existing ECHO code for correctness, security, resilience, performance, tests, and maintainability. Use for cauto enhancer sessions, hardening passes, quality upgrades, or focused refactors.
---
