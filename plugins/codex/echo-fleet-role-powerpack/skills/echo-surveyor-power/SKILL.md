...
description: Map ECHO systems, repositories, services, data flows, dependencies, drift, and risk from live evidence. Use for cauto surveyor sessions, inventory, topology, readiness, or gap analysis.
---
